...
expected =
    ...
    [ "diff -ru --unidirectional-new-file testdata/original/Debian/Repo/AptCache.hs testdata/copy/Debian/Repo/AptCache.hs",
      ...
      "+import Debian.Repo.Types.Common (EnvRoot(..), NamedSliceList(sliceList, sliceListName))",
      ...
      "+import Debian.Repo.Types.Common (EnvRoot(rootPath), outsidePath, RepoKey, repoKeyURI)",
      ...
      "+import Debian.Repo.Types.Common (NamedSliceList(..), repoKey, RepoKey(..), Slice(..), SliceList(..))",
      ...
      "+    ( rootEnvPath, appendPath, outsidePath, EnvPath(..), EnvRoot(..), compatibilityFile, libraryCompatibilityLevel, repoKeyURI, repoURI, RepoKey(..), Repo(..), NamedSliceList(..), SliceList(..), Slice(..)",
      "+    ) where",
      "+",
      "+import Control.Exception (throw)",
