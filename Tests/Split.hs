...
split4 =
    ...
    do system "rsync -aHxs --delete testdata/split4/ tmp"
       withCurrentDirectory "tmp" $
         do runMonadClean $ modifyModuVerse (const Set.empty) >> splitModule (S.ModuleName "Split4")
