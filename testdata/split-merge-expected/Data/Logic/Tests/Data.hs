...
import Data.Logic.Classes.FirstOrder (exists', FirstOrderFormula(..), for_all')
import Data.Logic.Classes.Negate ((.~.))
import Data.Logic.Classes.Skolem (Skolem(toSkolem))
import Data.Logic.Classes.Term (Term(..))
import qualified Data.Logic.Instances.Chiou as C (CTerm, Sentence)
import Data.Logic.KnowledgeBase (Proof(..), ProofResult(..), WithId(WithId, wiItem, wiIdent))
import Data.Logic.Normal.Implicative (ImplicativeForm(INF), makeINF')
import Data.Logic.Tests.Common (AtomicFunction, doProof, doTest, Expected(..), Pr, ProofExpected(..), TAtom, TestFormula(..), TestProof(..), TFormula, TTerm, TTestFormula, TTestProof, V)
...
formulas =
    ...
    , TestFormula
      ...
      , expected = [ SkolemNormalForm (pApp "P" [fApp (toSkolem "x") [],
                                                 vt ("y"),
                                                 vt ("z"),
                                                 fApp (toSkolem "u") [vt ("y"),vt ("z")],
                                                 vt ("v"),
    ...
    , let taller a b = pApp "taller" [a, b]
      ...
      , expected = [ClauseNormalForm
                    (toSS
                     [[(pApp ("wise") [vt ("y")]),
                       ((.~.) (pApp ("taller") [vt ("y"),fApp (toSkolem "x") [vt ("y")]]))],
                      [(pApp ("wise") [vt ("y")]),
    ...
    , let p = pApp "p" []
      ...
      , expected = [ PrenexNormalForm (exists "x" ((p .&. f') .|. ((((.~.) p) .&. (((.~.) f'))))))
                   ...
                   , TrivialClauses [(False,S.fromList [((.~.) (pApp ("p") [])),(pApp ("f") [fApp (toSkolem "x") []])]),
      ...
      , expected = [ClauseNormalForm
                    (toSS
                     [[(pApp2 ("f") (vt ("z")) (vt ("x"))),
                      ...
                      [(pApp2 ("f") (vt ("z")) (vt ("y"))),
                       (pApp2 ("f") (fApp (toSkolem "z") [vt ("x"),vt ("y")]) (vt ("x"))),
                       (pApp2 ("f") (fApp (toSkolem "z") [vt ("x"),vt ("y")]) (vt ("y"))),((.~.) (pApp2 ("f") (vt ("z")) (vt ("x"))))],
                      [(pApp2 ("f") (vt ("z")) (vt ("y"))),
                       ((.~.) (pApp2 ("f") (vt ("z")) (vt ("x")))),
                       ((.~.) (pApp2 ("f") (fApp (toSkolem "z") [vt ("x"),vt ("y")]) (vt ("x")))),
                       ((.~.) (pApp2 ("f") (fApp (toSkolem "z") [vt ("x"),vt ("y")]) (vt ("y"))))],
...
animalKB =
    ...
    , [ TestFormula
       ...
       , expected = [ClauseNormalForm (toSS [[(pApp "Dog" [fApp (toSkolem "x") []])],[(pApp "Owns" [fApp "Jack" [],fApp (toSkolem "x") []])]])]
       -- owns(jack,sK0)
       -- dog (SK0)
                   }
     , TestFormula
             ...
             (toSS
              [[(pApp ("Animal") [vt ("x")]),
               ...
               [(pApp ("AnimalLover") [vt ("x")]),
                ...
                ((.~.) (pApp ("Owns") [vt ("x"),vt ("y")]))],
               [(pApp ("Cat") [fApp ("Tuna") []])],
               [(pApp ("Dog") [fApp (toSkolem "x") []])],
               [(pApp ("Kills") [fApp ("Curiosity") [],fApp ("Tuna") []]),
                (pApp ("Kills") [fApp ("Jack") [],fApp ("Tuna") []])],
               [(pApp ("Owns") [fApp ("Jack") [],fApp (toSkolem "x") []])],
               [((.~.) (pApp ("Animal") [vt ("y")])),
                ((.~.) (pApp ("AnimalLover") [vt ("x")])),
                ((.~.) (pApp ("Kills") [vt ("x"),vt ("y")]))],
               [((.~.) (pApp ("Kills") [fApp ("Jack") [],fApp ("Tuna") []]))]])
                      ...
                      (((pApp ("P") [vt ("x"),vt ("y"),fApp (toSkolem "z") [vt ("x"),vt ("y")]]) .&.
                        ((((((((.~.) (pApp ("P") [vt ("x"),vt ("y"),vt ("u")])) .|.
                          ...
                          ((((pApp ("P") [vt ("x"),fApp ("e") [],vt ("x")]) .&.
                            ...
                            (((pApp ("P") [vt ("x"),fApp ("i") [vt ("x")],fApp ("e") []]) .&.
                              ((pApp ("P") [fApp ("i") [vt ("x")],vt ("x"),fApp ("e") []]))))))))) .&.
                       (((pApp ("P") [fApp (toSkolem "x") [],fApp (toSkolem "x") [],fApp ("e") []]) .&.
                         (((pApp ("P") [fApp (toSkolem "u") [],fApp (toSkolem "v") [],fApp (toSkolem "w") []]) .&.
                           (((.~.) (pApp ("P") [fApp (toSkolem "v") [],fApp (toSkolem "u") [],fApp (toSkolem "w") []]))))))))
                    , SkolemNumbers (S.fromList [toSkolem "u",toSkolem "v",toSkolem "w",toSkolem "x",toSkolem "z"])
                    -- From our algorithm
...
chang43ConjectureRenamed =
    ...
    TestFormula { name = "chang 43 renamed"
                ...
                , expected =
                    ...
                    , let a = fApp (toSkolem "u3") []
                          b = fApp (toSkolem "v3") []
                          c = fApp (toSkolem "w3") [] in
                      ClauseNormalForm
                      (toSS
                      [[(pApp ("P") [vt ("x"),vt ("y"),fApp (toSkolem "z") [vt ("x"),vt ("y")]])],
                       [((.~.) (pApp ("P") [vt ("x"),vt ("y"),vt ("u")])),
...
proofs =
    ...
    [ TestProof
      ...
      , proofExpected = 
          [ ChiouKB (S.fromList
                     [WithId {wiItem = INF (S.fromList []) (S.fromList [(pApp "Dog" [fApp (toSkolem "x") []])]), wiIdent = 1},
                      WithId {wiItem = INF (S.fromList []) (S.fromList [(pApp "Owns" [fApp "Jack" [],fApp (toSkolem "x") []])]), wiIdent = 1},
          ...
          , ChiouResult (False,
                         (S.fromList
                          [(inf' [(pApp "Kills" [fApp "Jack" [],fApp "Tuna" []])] [],fromList []),
                           ...
                           (inf' [(pApp "Animal" [fApp "Tuna" []]),(pApp "Owns" [fApp "Curiosity" [],fApp (toSkolem "x") []])] [],fromList []),
                           (inf' [(pApp "Cat" [fApp "Tuna" []]),(pApp "Dog" [vt "y"]),(pApp "Owns" [fApp "Curiosity" [],vt "y"])] [],fromList []),
                           (inf' [(pApp "AnimalLover" [fApp "Curiosity" []])] [],fromList []),
                           (inf' [(pApp "Cat" [fApp "Tuna" []]),(pApp "Owns" [fApp "Curiosity" [],fApp (toSkolem "x") []])] [],fromList []),
                           (inf' [(pApp "Dog" [vt "y"]),(pApp "Owns" [fApp "Curiosity" [],vt "y"])] [],fromList []),
                           (inf' [(pApp "Owns" [fApp "Curiosity" [],fApp (toSkolem "x") []])] [],fromList [])]))
          ]
      }
    , TestProof
      ...
      , proofExpected =
          [ ChiouKB (S.fromList
                     [WithId {wiItem = inf' []                                 [(pApp "Dog" [fApp (toSkolem "x") []])],                 wiIdent = 1},
                      WithId {wiItem = inf' []                                 [(pApp "Owns" [fApp "Jack" [],fApp (toSkolem "x") []])], wiIdent = 1},
          ...
          , ChiouResult (True,
                         ...
                         [(makeINF' ([]) ([]),fromList []),
                          ...
                          (makeINF' ([(pApp ("Animal") [fApp ("Tuna") []]),(pApp ("Dog") [fApp (toSkolem "x") []])]) ([]),fromList []),
                          (makeINF' ([(pApp ("Animal") [fApp ("Tuna") []]),(pApp ("Owns") [fApp ("Jack") [],fApp (toSkolem "x") []])]) ([]),fromList []),
                          ...
                          (makeINF' ([(pApp ("Cat") [fApp ("Tuna") []]),(pApp ("Dog") [fApp (toSkolem "x") []])]) ([]),fromList []),
                          (makeINF' ([(pApp ("Cat") [fApp ("Tuna") []]),(pApp ("Owns") [fApp ("Jack") [],fApp (toSkolem "x") []])]) ([]),fromList []),
    ...
    , let x = vt "x" in
      ...
      , proofExpected = 
         ...
         , ChiouResult (True,
                        S.fromList 
                        [(makeINF' ([]) ([]),fromList []),
                         (makeINF' ([]) ([(pApp ("Human") [fApp (toSkolem "x") []])]),fromList []),
                         (makeINF' ([]) ([(pApp ("Mortal") [fApp (toSkolem "x") []])]),fromList []),
                         (makeINF' ([]) ([(pApp ("Socrates") [fApp (toSkolem "x") []])]),fromList []),
                         (makeINF' ([(pApp ("Mortal") [fApp (toSkolem "x") []])]) ([]),fromList [])])]
      }
    , let x = vt "x" in
      TestProof
      ...
      , proofExpected = 
         [ ChiouKB (S.fromList
                    [WithId {wiItem = inf' [(pApp "Human" [vt "x"])] [(pApp "Mortal" [vt "x"])], wiIdent = 1},
                     WithId {wiItem = inf' [(pApp "Socrates" [vt "x"])] [(pApp "Human" [vt "x"])], wiIdent = 2}])
         , ChiouResult (False,
                        S.fromList [(makeINF' ([]) ([(pApp ("Human") [fApp (toSkolem "x") []])]),fromList []),
                                    (makeINF' ([]) ([(pApp ("Mortal") [fApp (toSkolem "x") []])]),fromList []),
                                    (makeINF' ([]) ([(pApp ("Socrates") [fApp (toSkolem "x") []])]),fromList []),
